...
parent.document.getElementById('di').addEventListener('click', function() {flat();});
var vid = parent.document.getElementById("cp");
var rott = 0;
vid.setAttribute("style", "transform-origin: center");
function flat(){
vid.setAttribute("style", "transform: rotate(0deg)");
};
function rota() {
vid.setAttribute("style", "transform: rotate(" + rott + "deg)"); 
};
