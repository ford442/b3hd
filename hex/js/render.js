...
var upperheight = (trueCanvas.height/2) - ((settings.rows * settings.blockHeight) * (2/Math.sqrt(3))) * (4/3);
var lowerheight = (trueCanvas.height/2) + ((settings.rows * settings.blockHeight) * (2/Math.sqrt(3))) * (9/16);
var text = '';
var mob, fontSize;
...
action_text = 'and up to drop.'
score_text = 'MERRY CHRISTMAS 2020!'
fontSize = 27
}
