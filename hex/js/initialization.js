...
window.colors = ["rgba(250,0,16,1)", "rgba(255,255,0,0.2)", "rgba(0,179,44,1)", "rgba(0,0,255,.2)"];
window.hexColorsToTintedColors = {
"#884599": "rgb(136,69,153)",
"#ffffff": "rgba(255,255,255,0.4)",
"#000000": "rgba(0,0,255,0.4)",
"#419c46": "rgb(65,156,70)"
};
window.rgbToHex = {
"rgb(231,76,60)": "#884599",
"rgb(241,196,15)": "#ffffff",
"rgb(52,152,219)": "#000000",
"rgb(46,204,113)": "#419c46"
};
window.rgbColorsToTintedColors = {
"rgb(231,76,60)": "rgb(136,69,153)",
"rgb(241,196,15)": "rgb(255,255,255)",
"rgba(255,255,255,0.2)": "rgba(0,0,0,0.1)",
"rgb(46,204,113)": "rgb(65,156,70)"
};
window.hexagonBackgroundColor = 'rgba(255,255,255,0)';
window.hexagonBackgroundColorClear = 'rgba(255, 255, 255, 0)';
window.centerBlue = 'rgba(255,255,255,0)';
